...
def plot_response_files(kwargs):
    ...
    # fig1.savefig("v2.7_vs_kmht_70_to_40db_rate_plot.png", dpi=dpi, bbox_inches="tight",facecolor="white")
    # plt.close(fig1)

    fig2 = plt.figure(figsize=(fig_width, 20))
    ...
    fig2.savefig("v2.7_vs_kmht_60_to_70db_tp_plot.png",dpi=dpi, bbox_inches="tight", facecolor="white")
    plt.close(fig2)


    fig3 = plt.figure(figsize=(fig_width, 20))
    gs1 = gridspec.GridSpec(num_subplots, 1, height_ratios=[5, 5])
    ax3 = fig3.add_subplot(gs1[0])

    plot_throughput_summary_by_segment(
        {
            "df": measured_throughput_data,
            "ax": ax3,
            "rounded_position": rounded_positions,
    ...
    fig3.savefig("v2.7_vs_60_to_70db_mean_median_summary_plot.png",dpi=dpi, bbox_inches="tight", facecolor="white")
    plt.close(fig3)
